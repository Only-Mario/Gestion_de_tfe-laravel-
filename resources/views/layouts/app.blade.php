...
<head>
    ...
    <title>{{ config('APP_NAME', 'INSTI | TFE') }}</title>
    <!-- Styles -->
    <link href="{{ asset('css/app.css') }}" rel="stylesheet">
    <link href="{{ asset('css/style.css') }}" rel="stylesheet">
    <style>
        .search-by-entity-items,
        .search-by-year-items {
            display: none;
        }
    </style>
    <!--     //********************-****-->
            ...
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3"
                            id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button><label
                            class="justify-content-center">Plateforme de gestion des rapports de fin dՎtude</label>
